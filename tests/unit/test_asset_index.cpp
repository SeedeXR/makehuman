...
TEST_CASE("the shipped assets index by uuid", "[core][assetindex][golden]") {
    ...
    // Counted from disk: 11 proxies (base.mhclo, a7_converter.proxy, the two
    // eye meshes and the generated teeth, tongue, hair, AFRO, skirt, tights and
    // eyelashes) plus 22 materials -- the 3 originals (xray, default skin, brown
    // eye), the 8 generated skin tones (tools/make_skins.py), the 5 generated
    // eye colours (tools/make_eyes.py) and the 6 generated helper-cage
    // materials (tools/make_helper_proxies.py).
    CHECK(idx.size() == 33);
