...
TEST_CASE("the shipped assets index by uuid", "[core][assetindex][golden]") {
    ...
    // Counted from disk: 13 proxies (base.mhclo, a7_converter.proxy, the two
    // eye meshes and the generated teeth, tongue, hair, AFRO, CORNROWS, skirt,
    // tights, eyelashes and genitals) plus 23 materials -- the 3 originals
