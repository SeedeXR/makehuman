...
TEST_CASE("the shipped assets index by uuid", "[core][assetindex][golden]") {
    ...
    // Counted from disk: 12 proxies (base.mhclo, a7_converter.proxy, the two
    // eye meshes and the generated teeth, tongue, hair, AFRO, skirt, tights,
    // eyelashes and genitals) plus 23 materials -- the 3 originals (xray,
    // default skin, brown eye), the 8 generated skin tones
