...
constexpr std::array<ProxySlot, 7> kProxySlots{{{"teeth", "Teeth", "teeth"},
                                                {"genitals", "Genitals", "none", true},
                                                {"tongue", "Tongue", "none"},
                                                {"hair", "Hair", "none"},
                                                {"clothes", "Clothes", "none"},
                                                {"eyelashes", "Eyelashes", "none"},
                                                // Added 2026-09-24. Unlike every slot above it,
                                                // this one has NO helper cage in the base mesh --
                                                // `tools/make_eyebrows.py` binds the geometry to
                                                // the face directly, the way the locs bind to the
                                                // scalp, so the slot needed no change to
                                                // base.obj.
